...
export const useDelhiveryB2BAppointmentBook = () =>
  useMutation({
    mutationFn: bookDelhiveryB2BAppointment,
  })

export const useDelhiveryB2BPickupRequestCreate = () =>
  useMutation({
    mutationFn: createDelhiveryB2BPickupRequest,
  })

export const useDelhiveryB2BPickupRequestCancel = () =>
  useMutation({
    mutationFn: cancelDelhiveryB2BPickupRequest,
  })

export const useDelhiveryB2BLabelUrls = () =>
  useMutation({
    mutationFn: getDelhiveryB2BLabelUrls,
  })
...
export const useDelhiveryB2BDocumentStatus = () =>
  useMutation({
    mutationFn: getDelhiveryB2BDocumentStatus,
  })
