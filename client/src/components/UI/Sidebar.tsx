...
const BRAND_ORANGE = brand.colors.primary
const BRAND_SURFACE = brand.colors.surface
  ...
  return (
    ...
    >
      ...
      >
        <Box
          sx={{
            width: shouldShowExpanded ? 148 : 48,
            height: 48,
            borderRadius: 1.5,
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <BrandMark
            variant={shouldShowExpanded ? 'full' : 'icon'}
            width={shouldShowExpanded ? 136 : 42}
