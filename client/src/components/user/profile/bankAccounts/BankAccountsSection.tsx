    ...
    <Stack spacing={3} width={'100%'}>
      <Box
        sx={{
          ...
          gap: 1.5,
          p: 2,
          border: `1px solid ${alpha('#333d81', 0.12)}`,
          background:
            'linear-gradient(180deg, rgba(255,255,255,0.98) 0%, rgba(251,245,242,0.98) 100%)',
        }}
      >
        <Stack spacing={0.4}>
          <Typography sx={{ fontSize: '0.72rem', letterSpacing: '0.16em', fontWeight: 800, color: '#ce2826', textTransform: 'uppercase' }}>
            Settlement accounts
          </Typography>
          ...
          <Typography sx={{ fontSize: '0.92rem', color: '#4B5563' }}>
            Control where IntleExpress settles funds and which account remains primary for operations.
          </Typography>
        </Stack>
