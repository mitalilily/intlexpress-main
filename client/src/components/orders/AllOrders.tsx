      ...
      <>
        <Button
          ...
          sx={{
            ...
            color: isMenuOpen ? '#FFFFFF' : '#333d81',
            bgcolor: isMenuOpen ? '#333d81' : '#FFFFFF',
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                borderColor: '#B40312',
                backgroundColor: alpha('#333d81', 0.06),
              },
              '&:disabled': {
                borderColor: alpha('#333d81', 0.4),
                color: alpha('#333d81', 0.4),
              },
            }}
          >
        ...
        >
          {filterChips.map((chip) => (
            <Chip
              ...
              sx={{
                backgroundColor: alpha('#333d81', 0.08),
                color: '#333d81',
                fontWeight: 500,
                border: `1px solid ${alpha('#333d81', 0.2)}`,
                '& .MuiChip-deleteIcon': {
                  color: alpha('#333d81', 0.6),
                  '&:hover': {
                    color: '#333d81',
                  },
                },
            ...
            >
                          ...
                          >
                            <Typography
                              sx={{
                                ...
                                fontWeight: 500,
                                color:
                                  downloadingDocumentType === item.type ? '#333d81' : '#111827',
                              }}
                            >
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': {
                    color: '#333d81',
                    backgroundColor: alpha('#333d81', 0.05),
                  },
                }}
              >
                Clear
