  ...
  const cards = [
    {
      ...
      onClick: () => window.open('https://despatchgo.com/blogs', '_blank'),
    },
    {
        ...
        {cards.map((card, index) => (
          <Grid size={{ md: 6, xs: 12 }} key={index}>
            ...
            >
              ...
              {/* Title */}
              <Typography fontWeight={600} fontSize="16px" sx={{ color: '#333d81' }}>
                {card.title}
              </Typography>
              ...
              <Typography
                variant="body2"
                sx={{ color: '#333d81', fontSize: '13px', lineHeight: 1.6, opacity: 0.8 }}
              >
                {card.description}
              </Typography>
