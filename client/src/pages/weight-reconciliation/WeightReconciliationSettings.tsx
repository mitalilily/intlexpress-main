...
export default function WeightReconciliationSettings() {
  const BRAND_PURPLE = '#333d81'
  const BRAND_ORANGE = '#ce2826'
  const sectionCardSx = {
      ...
      <Stack gap={3}>
        ...
        >
          ...
          <Typography variant="body2" sx={{ color: '#6B7280', mt: 0.5, fontSize: '14px' }}>
            Configure thresholds, alerts, and reporting rules with a cleaner IntelExpress workflow.
          </Typography>
        ...
        <form onSubmit={handleSubmit}>
          <Stack gap={3}>
            <Box sx={sectionCardSx}>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#333d81', mb: 1 }}>
                Auto-Acceptance
              </Typography>
              ...
              {formData.autoAcceptEnabled && (
                <Alert
                  ...
                  sx={{
                    ...
                    borderLeft: '4px solid #333d81',
                    '& .MuiAlert-icon': {
                      color: '#333d81',
                    },
                  }}
                >
                  <Typography variant="body2" sx={{ fontWeight: 600, color: '#333d81', mb: 1 }}>
              ...
              <Stack gap={3}>
                ...
                >
                  <Box>
                    <Typography sx={{ fontWeight: 600, color: '#333d81', mb: 0.5 }}>
                      Enable Auto-Accept
                    </Typography>
                ...
                {formData.autoAcceptEnabled && (
                  <>
                    ...
                    <Box>
                      <Typography
                        sx={{ fontWeight: 600, color: '#333d81', mb: 1.5, fontSize: '14px' }}
                      >
                        Weight Threshold (kg)
                      </Typography>
                      <TextField
