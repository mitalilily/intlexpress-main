...
const ColorConnector = styled(StepConnector)(() => ({
  ...
  '&.Mui-active .MuiStepConnector-line': { backgroundColor: '#333d81' },
      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4}>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            >
              <Typography variant="h5" fontWeight={700} color="#333d81" gutterBottom sx={{ mb: 3 }}>
                Shipment Details
              </Typography>
          ...
          <Grid size={{ xs: 12, md: 8 }}>
            ...
            >
                      ...
                      >
                        <Typography
                          ...
                          sx={{
                            ...
                            color: index <= currentStage || isCancelled ? '#333d81' : '#4A5568',
                            mt: 1,
                          }}
                        >
                          {stageHistory
              ...
              <Box sx={{ mt: 5 }}>
                <Typography variant="h6" fontWeight={700} color="#333d81" mb={3}>
                  Tracking History
                </Typography>
